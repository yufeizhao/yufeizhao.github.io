...
>
> _(Another aside)_ While we are on the topic of names, it's also worth pointing out that Chinese surnames tend cluster late in the alphabet. This creates an interesting effect when you scroll to the bottom of a  [math](https://math.mit.edu/directory/faculty/index.php) department [directory](https://math.mit.edu/directory/graduate.php).
> 
